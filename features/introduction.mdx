...
<Card title="Contextual Prioritization" icon="alert-triangle" href="/features/vs/contextual-prioritization">
...
<Card title="Group-Based Scanning" icon="layers" href="/features/vs/group-scanning">
...
<Card title="VM & Ticketing Integrations" icon="git-merge" href="/features/vs/integrations">
  Send findings directly into VM workflows or external tools like Jira for end-to-end remediation tracking.
</Card>

<Card title="Continuous Scanning" icon="refresh-ccw" href="/features/vs/continuous-scanning">
