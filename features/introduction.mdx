...
<Card title="Project-Centric Workspace" icon="folder-tree" href="/features/tm/project-workspace">
  Each project includes its own metrics, endpoints, members, and lifecycle tracking for structured threat modeling.
</Card>

<Card title="Endpoint Threat Mapping" icon="sitemap" href="/features/tm/threat-mapping">
  Automatically discover API endpoints and map associated threats, methods, hosts, and density statistics.
</Card>

<Card title="Structured Threat Review" icon="table-list" href="/features/tm/threat-console">
