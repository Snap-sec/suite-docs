...
<Card title="Automatic Risk Assessment" icon="code" href="/features/aim/api-application-inventory">
...
<Card title="Blast Radius Explorer" icon="building" href="/features/blast-radius">
