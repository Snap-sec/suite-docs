...
<Banner>
The **Certificates Library** in AIM provides full visibility into SSL/TLS certificate lifecycles — helping teams detect expired, invalid, shadowed, or soon-to-expire certificates before they cause outages or security incidents.
</Banner>

<Frame caption="Certificates Library Overview">
  <img src="/images/aim/certificates1.png" alt="Certificates Library Dashboard" />
</Frame>
...
The **Certificates Library** aggregates all SSL/TLS certificates discovered via ASM, VM, cloud integrations, or network scanners.
