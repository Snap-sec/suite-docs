...
<Card title="Open an Application Record" icon="arrow-right" href="/products/aim/apps/view">
  Explore detailed application profiles, vulnerabilities, and relationships.
</Card>
