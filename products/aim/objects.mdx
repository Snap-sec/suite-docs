...
<Card title="View Bucket Details" icon="arrow-right" href="/products/aim/object-storage/details">
  Explore the full metadata, risk posture, and associations for each storage bucket.
</Card>
