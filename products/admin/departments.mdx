...
<Frame caption="Add Team action within a department">
  <img src="/images/admin/add-team-department.png" alt="Add Team button inside department view" />
</Frame>
...
<Frame caption="Update Department Teams modal">
  <img src="/images/admin/update-department-teams.png" alt="Modal to add or remove teams from a department" />
</Frame>
