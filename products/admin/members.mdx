...
<Frame caption="Invite members to your Snapsec workspace">
  <img
    src="/images/admin/members-invited.png"
    alt="Invite members using email, role, and team selection"
  />
</Frame>

The **Invite Members** flow allows administrators to onboard users securely without manual account setup.

### Invitation Methods
- **Email Invitations** — Invite users by email with predefined roles and team assignments.
- **Role Assignment** — Set Admin or Member access at invite time.
- **Team Mapping** — Automatically place users into the correct teams.
- **Instant Access** — Users gain access immediately after accepting the invite.

This ensures fast onboarding while maintaining access control and accountability.
