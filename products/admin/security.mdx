...
<Frame caption="Security section entry point inside Settings">
  <img src="/images/admin/activity.png" alt="Security navigation entry showing where to access security controls" />
</Frame>
...
<Frame caption="Current user sessions across the organization">
  <img src="/images/admin/current-sessions.png" alt="Table showing active user sessions with browser, device, OS, and last login time" />
</Frame>
...
<Frame caption="Device access and login history">
  <img src="/images/admin/device-security.png" alt="Device security table showing login devices and access details" />
</Frame>
...
<Frame caption="Detailed security and activity logs">
  <img src="/images/admin/security-logs1.png" alt="Security logs table showing events, HTTP methods, users, IP addresses, and timestamps" />
</Frame>
...
<Frame caption="Frequently asked questions related to security and access">
  <img src="/images/admin/FAQS-cs.png" alt="FAQ section under current sessions" />
</Frame>
