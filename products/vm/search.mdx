...
<Frame caption="Advanced vulnerability search with keyword input, filtering, and real-time results">
  <img src="/images/vm/search12.png" alt="Advanced vulnerability search interface with keyword search, filtering, and real-time results" />
</Frame>
