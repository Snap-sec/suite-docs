...
<Frame caption="Create a new operational dashboard">
  <img
    style={{ borderRadius: '0.5rem' }}
    src="/images/vm/create-dashboard-1.png"
  />
</Frame>
...
<Frame caption="Configure dashboard information and linked assessments">
  <img
    style={{ borderRadius: '0.5rem' }}
    src="/images/vm/dashboard-details-1.png"
  />
</Frame>
...
<Frame caption="Sources List displaying all registered vulnerability sources and their performance metrics">
  <img
    style={{ borderRadius: '0.5rem' }}
...
<Frame caption="Signal Analytics showing scanner accuracy, noise analysis, and confidence distribution">
  <img
    style={{ borderRadius: '0.5rem' }}
