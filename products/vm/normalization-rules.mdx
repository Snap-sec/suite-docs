...
<Frame caption="Normalization Engine Dashboard">
  ![](/images/vm/normalization-overview.png)
</Frame>
...
<Frame caption="Create Normalization Rule – Conditions">
  ![](/images/vm/normalization-create-rule.png)
</Frame>
...
<Frame caption="Normalization Rule – Set Discrete Severity">
  ![](/images/vm/normalization-actions-severity.png)
</Frame>
...
<Frame caption="Normalization Rule – Transform CVSS Score">
  ![](/images/vm/normalization-actions-cvss.png)
</Frame>
...
<Frame caption="Execute Normalization Confirmation">
  ![](/images/vm/normalization-execute.png)
</Frame>
