...
description: "Prioritize vulnerabilities using normalization rules and adaptive True Risk scoring."
icon: "ranking-star"
mode: "wide"
---
...
<Frame caption="Configure Asset Type">
  ![](/images/vm/true-risk-scoring-expanded-2.png)
</Frame>

<Frame caption="Configure Business Unit Risk scoring">
  ![](/images/vm/true-risk-scoring-expanded-4.png)
</Frame>
