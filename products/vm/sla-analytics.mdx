...
<Frame caption="Weekly Reports configuration for automated SLA reporting">
  <img src="/images/vm/sla-weekly-config.png" alt="Weekly SLA Reports configuration screen" />
</Frame>
...
You can customize when and to whom the SLA reports are sent.
...
<Frame caption="Send Now confirmation for weekly SLA report">
  <img src="/images/vm/sla-weekly-send.png" alt="Send Now confirmation modal for SLA weekly report" />
</Frame>
