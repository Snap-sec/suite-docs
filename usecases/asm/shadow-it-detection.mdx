...
<Tip>
  Most organizations discover assets <strong>after attackers do</strong>. Shadow IT is one of the biggest contributors to real-world breach events.
</Tip>
...
<CardGroup cols={3}>
  ...
  <Card title="Cloud Blind Spots" icon="cloud">
