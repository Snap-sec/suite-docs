...
<Card title="Automated Asset Catalog" icon="folder-tree" href="/usecases/aim/automated-asset-catalog">
  Build and maintain a live, enriched inventory of every asset across environments and teams.
</Card>

<Card title="Intelligent Asset Classification" icon="tags" href="/usecases/aim/intelligent-asset-classification">
...
<Card title="Ownership & Team Mapping" icon="id-badge" href="/usecases/aim/ownership-and-team-mapping">
...
<Card title="Automated Threat Mapping" icon="exclamation-triangle" href="/usecases/tm/automated-threat-mapping">
  Generate a visual threat map from system diagrams or API collections automatically.
</Card>

<Card title="Risk Pattern Analysis" icon="cube" href="/usecases/tm/risk-pattern-analysis">
  Analyze system behavior and discover common attack patterns or weak controls.
</Card>


<Card title="Developer Enablement" icon="laptop" href="/usecases/tm/developer-enablement">
  Provide developers with actionable, system-specific security guidance.
</Card>

<Card title="Logic Flaw Identification" icon="lightbulb" href="/usecases/tm/logic-flaw-identification">
...
<Card title="Continuous API Fuzzing" icon="bug" href="/usecases/apiguard/continuous-api-fuzzing">
  Stress-test APIs continuously to uncover injection, validation, and parsing weaknesses.
</Card>

<Card title="Auth Weakness Detection" icon="lock-open" href="/usecases/apiguard/auth-weakness-detection">
  Identify broken authentication and authorization issues across sensitive endpoints.
</Card>

<Card title="API Misconfiguration Testing" icon="sliders" href="/usecases/apiguard/api-misconfiguration-testing">
  Detect insecure CORS, excessive exposure, debug endpoints, and configuration flaws.
</Card>

<Card title="API Threat Intelligence" icon="brain" href="/usecases/apiguard/api-threat-intelligence">
