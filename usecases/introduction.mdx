...
<Card title="Continuous API Fuzzing" icon="bug" href="/usecases/was/continuous-api-fuzzing">
  Stress-test APIs continuously to uncover injection, validation, and parsing weaknesses.
</Card>

<Card title="Auth Weakness Detection" icon="lock-open" href="/usecases/was/auth-weakness-detection">
  Identify broken authentication and authorization issues across sensitive endpoints.
</Card>

<Card title="API Misconfiguration Testing" icon="sliders" href="/usecases/was/api-misconfiguration-testing">
  Detect insecure CORS, excessive exposure, debug endpoints, and configuration flaws.
</Card>

<Card title="API Threat Intelligence" icon="brain" href="/usecases/was/api-threat-intelligence">
