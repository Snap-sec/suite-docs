---
title: TruffleHog
description: Step-by-step guide to run TruffleHog in GitHub or GitLab CI and push findings into Snapsec VM via webhook.
mode: wide
---

## TruffleHog CI/CD integration with Snapsec VM

Use **TruffleHog** in your CI pipeline to scan your repositories for secrets (API keys, tokens, passwords, etc.) and then push the findings into Snapsec VM using a simple webhook.
