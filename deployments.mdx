...
<Card title="On-Premise Deployment" icon="building" href="/deployment/onprem">
  Host Snapsec Suite within your own infrastructure for complete data ownership and compliance assurance.
</Card>

<Card title="Cloud Account" icon="cloud" href="/deployment/cloud">
...
<Card title="Request On-Prem Access" icon="arrow-right" href="https://suite.snapsec.co/onprem-request">
  Contact our deployment team to get your private installer package and setup guide.
</Card>

<Card title="Start Cloud Trial" icon="rocket" href="https://suite.snapsec.co/signup">
  Create your Snapsec Cloud account and start securing your environment within minutes.
</Card>
